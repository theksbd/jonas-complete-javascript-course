...
const population = 925;
const isIsland = false;
let language;
language = "Vietnamese";

const populationInSouthVN = population / 2;
const populationInNorthVN = population / 2;

const description = `${country} in in ${continent} and its ${population} million people speak ${language}`;
